...
# CUDA_VISIBLE_DEVICES=4 python main.py -O --image data/anya_front_rgba.png --workspace trial_anya_1_refimage \
#   --iters 10000 --save_guidance --f 10 --ckpt scratch --batch_size 2 --test_interval 2 \
...
# CUDA_VISIBLE_DEVICES=4 python main.py -O --image data/anya_front_rgba.png --workspace trial_anya_1_refimage_B_GPU2_reproduction1_GPU2 \
...
#   --h 256 --w 256 --albedo_iter_ratio 0.0 --t_range 0.2 0.6 --batch_size 2 --radius_range 2.2 2.6 --test_interval 2 \
...
#   # --dataset_size_train 100 --dataset_size_test 100
...
# CUDA_VISIBLE_DEVICES=4 python main.py -O --image data/anya_front_rgba.png --workspace trial_anya_1_refimage_B_GPU2_reproduction1_GPU2_refinedGPU2 \
#   --text "A DSLR 3D photo of a cute anime schoolgirl stands proudly with her arms in the air, pink hair ( unreal engine 5 trending on Artstation Ghibli 4k )" \
#   --iters 27500 --ckpt trial_anya_1_refimage_B_GPU2_reproduction1_GPU2/checkpoints/df_ep0150.pth  --save_guidance --save_guidance_interval 1 \
#   --h 484 --w 484 --albedo_iter_ratio 0.0 --t_range 0.0 0.5 --batch_size 1 --radius_range 3.2 3.6 --test_interval 2 \
...
#   --exp_start_iter 15000 --exp_end_iter 27500

# Generate 6 views
# CUDA_VISIBLE_DEVICES=4 python main.py -O --image data/anya_front_rgba.png --ckpt trial_anya_1_refimage_B_GPU2_reproduction1_GPU2_refinedGPU2/checkpoints/df_ep0275.pth --six_views

# Phase 4 - untested, need to adjust
CUDA_VISIBLE_DEVICES=0 python main.py -O --image data/anya_front_rgba.png --workspace trial_anya_1_refimage_dmtet --iters 5000 --dmtet --init_with trial_anya_1_refimage/checkpoints/df.pth
